  ...
  <div>
    <div>
      <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal"
               select="handleSelect"
               router=true default-active="/TeaInfo"
    ...
    <el-card class="box-card"style="margin-top: 1%;padding-bottom: 6%">
      <el-container>
        <el-container>
          <img src="../../assets/bill.png"style="width: 350px;height: 350px;padding-top: 5%;padding-left: 10%">
        </el-container>
          <el-container>
    <el-descriptions class="margin-top" title="个人基本信息" :column="2"  border  >
      <template slot="extra" >
        <el-button type="primary" size="small" @click="changeinfo">信息修改</el-button>
      </template>
