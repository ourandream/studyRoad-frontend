<template>
  <div>
    ...
    <el-card class="scopde">
      <!--      查询条件区-->
      <el-row :gutter="0">
        <el-form ref="scoreFind" :model="scoreFind" :rules="rules" size="mini" label-width="100px"
        style="text-align: left">
          <el-col :span="6">
            <el-form-item label="年级" prop="grade">
              <el-select v-model="scoreFind.grade" placeholder="请选择学生年级" clearable :style="{width: '100%'}">
          ...
          <el-col :span="6">
            <el-form-item label="姓名" prop="name">
              <el-input v-model="scoreFind.name" placeholder="请输入学生姓名" clearable :style="{width: '100%'}">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="学年" prop="scyear">
              <el-select v-model="scoreFind.scyear" placeholder="请选择课程学年" clearable :style="{width: '100%'}">
          ...
          <el-col :span="6">
            <el-form-item label="学期" prop="semester">
              <el-select v-model="scoreFind.semester" placeholder="请选择课程学期" clearable :style="{width: '100%'}">
          ...
          <el-col :span="6">
            <el-form-item label="课程" prop="coursename">
              <el-input v-model="scoreFind.coursename" placeholder="请输入课程名" clearable :style="{width: '100%'}">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="课程性质" prop="coursenature">
              <el-select v-model="scoreFind.coursenature" placeholder="请选择课程性质" clearable
                         :style="{width: '100%'}">
                <el-option v-for="(item, index) in coursenatureOptions" :key="index" :label="item.label"
                           :value="item.value" :disabled="item.disabled"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-tag  v-if="scope.row.courna===2"type="warning" size="mini">选修</el-tag>
          </template>
        </el-table-column>
        <el-table-column
          prop="courid"
...
.scopde{
  height: 100%;
  background: #fcfcfc url('../../../assets/bac/scorede.png') no-repeat top  right/ 25% auto;
}
</style>
