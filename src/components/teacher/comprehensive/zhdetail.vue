    ...
    <div>
      ...
      <el-breadcrumb separator="》" style="padding-left:10px;padding-bottom:1%;font-size:15px;padding-top: 0.5%;">
        ...
        <el-breadcrumb-item>个人综测详细</el-breadcrumb-item>
          ...
          <el-container>
            <el-descriptions size="medium" border  style="margin-left: 10%;padding-right: 50%" >
              <el-descriptions-item label="综测学年" label-class-name="zhmy-label" content-class-name="zhmy-content">{{this.scyear}}</el-descriptions-item>
            </el-descriptions>
