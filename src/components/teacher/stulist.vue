  ...
  <div>
    ...
    <el-card style="height: 100%">
      ...
      >
        ...
        <el-table-column prop="stusex" label="性别" width="60">
        ...
        <el-table-column prop="stugrade" label="年级" sortable width="100">
        </el-table-column>
        <el-table-column prop="stumajor" label="专业"> </el-table-column>
        <el-table-column prop="stuemail" label="邮箱" width="180">
        </el-table-column>
        <el-table-column prop="stuinstructor" label="辅导员" width="100">
        </el-table-column>
