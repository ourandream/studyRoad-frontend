  ...
  <div>
    ...
    <el-container>
      <el-container>
        <el-card style="width: 600px; height: 610px">
          ...
          >
            ...
            <el-table-column prop="experience" label="学生工作经历" width="110">
            </el-table-column>
      ...
      <img
        ...
        style="width: 300px; height: 300px; padding-top: 8%"
      />
      <el-container>
        <el-card style="width: 600px; height: 610px">
          <h4>非管理员学生列表</h4>
          <el-row :gutter="15">
            ...
            >
              <el-col :span="12">
                ...
                <el-form-item label="年级" prop="grade">
                  <el-select
                    v-model="inperUser.grade"
                    placeholder="请选择年级"
                    clearable
                    :style="{ width: '100%' }"
                  >
                    <el-option
                      v-for="(item, index) in gradeOptions2"
                      :key="index"
                      :label="item.label"
                      :value="item.value"
                      :disabled="item.disabled"
                ...
                <el-tooltip placement="top" effect="light">
                  ...
                  >
                    <el-button
                      ...
                      slot="reference"
                      size="small"
                      style="background-color: rgba(189, 243, 131, 0.71)"
