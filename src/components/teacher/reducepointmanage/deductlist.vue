  ...
  <div>
    ...
    <el-card class="depoint">
        ...
        >
          ...
          <el-col :span="7">
            <el-form-item label="学期" prop="desemester">
              <el-select
                v-model="depointFind.desemester"
                placeholder="请选择扣分学期"
                clearable
                :style="{ width: '100%' }"
              >
      ...
      >
        ...
        <el-table-column prop="matter" label="扣分事项" width="130">
        </el-table-column>
        <el-table-column prop="describe" label="扣分简介"> </el-table-column>
        <el-table-column prop="remarks" label="扣分备注" width="130">
        </el-table-column>
        <el-table-column prop="mark" label="扣分数" sortable width="100">
          <template slot-scope="scope">
...
.depoint {
  height: 100%;
  background: #fcfcfc url("../../../assets/bac/cheer.png") no-repeat top right/
    20% auto;
}
</style>
