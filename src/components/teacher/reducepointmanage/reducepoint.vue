          ...
          <el-row :gutter="0">
            ...
            >
              <el-col :span="12">
                ...
                >
                  <el-input
                    v-model="deductForm.dename"
                    placeholder="请输入扣分学生姓名"
                    clearable
                    :style="{ width: '100%' }"
                  >
                  </el-input>
              ...
              <el-col :span="12">
                <el-form-item label="学号" prop="denum" style="padding-top: 6%">
                  <el-input
                    v-model="deductForm.denum"
                    placeholder="请输入扣分学生学号"
                    clearable
                    :style="{ width: '100%' }"
                  >
                  </el-input>
              ...
              <el-col :span="12">
                ...
                >
                  <el-select
                    v-model="deductForm.degrade"
                    placeholder="请选择扣分学生年级"
                    clearable
                    :style="{ width: '100%' }"
                  >
                    <el-option
              ...
              <el-col :span="12">
                ...
                >
                  <el-select
                    v-model="deductForm.desemester"
                    placeholder="请选择扣分学期"
                    clearable
                    :style="{ width: '100%' }"
                  >
                    <el-option
                      v-for="(item, index) in desemesterOptions"
                      :key="index"
                      :label="item.label"
                      :value="item.value"
                      :disabled="item.disabled"
...
.reCard {
  ...
  background: #fcfcfc url("../../../assets/bac/reducepoint.png") no-repeat
    bottom right/ 30% auto;
