<template>
  <el-dialog title="基本信息修改" :visible.sync="dialogFormVisible" class="changeInfo" center @close="Close">
    <el-row :gutter="15">
      <el-form ref="teaUser" :model="tea" :rules="rules" size="medium" label-width="100px">
        <el-col :span="11">
          <el-form-item label="工号" prop="id">
            <el-input v-model="tea.id" placeholder="请输入工号" readonly :disabled='true' clearable
                      prefix-icon='el-icon-s-help' :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="11">
          <el-form-item label="姓名" prop="name">
            <el-input v-model="tea.name" placeholder="请输入姓名" :disabled='true' clearable prefix-icon='el-icon-s-help'
        ...
        <el-col :span="11">
          <el-form-item label="民族" prop="nation">
            <el-input v-model="tea.nation" placeholder="请输入民族" clearable prefix-icon='el-icon-lock'
                      :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="11">
          <el-form-item label="籍贯" prop="naPlace">
            <el-input v-model="tea.naPlace" placeholder="请输入籍贯" clearable prefix-icon='el-icon-lock'
                      :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="11">
          <el-form-item label="政治面貌" prop="poLook">
            <el-input v-model="tea.poLook" placeholder="请输入政治面貌" clearable prefix-icon='el-icon-lock'
                      :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="11">
          <el-form-item label="身份证号" prop="idCard">
            <el-input v-model="tea.idCard" placeholder="请输入身份证号" clearable prefix-icon='el-icon-lock'
                      :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="11">
          <el-form-item label="出生日期" prop="birthDate">
            <el-date-picker v-model="tea.birthDate" format="yyyy-MM-dd" value-format="yyyy-MM-dd"
                            :style="{width: '100%'}" placeholder="请选择出生日期" clearable></el-date-picker>
          </el-form-item>
        </el-col>
        <el-col :span="11">
          <el-form-item label="电话" prop="phone">
            <el-input v-model="tea.phone" placeholder="请输入电话" clearable prefix-icon='el-icon-lock'
                      :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="11">
          <el-form-item label="邮箱" prop="email">
            <el-input v-model="tea.email" placeholder="请输入邮箱" clearable prefix-icon='el-icon-lock'
                      :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="11">
          <el-form-item label="微信号" prop="wechat">
            <el-input v-model="tea.wechat" placeholder="请输入微信号" clearable prefix-icon='el-icon-lock'
                      :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
