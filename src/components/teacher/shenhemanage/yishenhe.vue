<template>
  <div>
    ...
    <el-card class="yishen">
      <!--      查询条件区-->
      <el-row :gutter="0">
        <el-form ref="yishenFind" :model="yishenFind" :rules="rules" size="small" label-width="100px">
          <el-col :span="4">
            <el-form-item label="年级" prop="degrade">
              <el-select v-model="yishenFind.degrade" placeholder="请选择年级" clearable :style="{width: '100%'}">
          ...
          <el-col :span="5">
            <el-form-item label="学年" prop="descyear">
              <el-select v-model="yishenFind.descyear" placeholder="请选择扣分学年" clearable :style="{width: '100%'}">
          ...
          <el-col :span="5">
            <el-form-item label="模块" prop="demodule">
              <el-select v-model="yishenFind.demodule" placeholder="请选择扣分模块" clearable :style="{width: '100%'}">
          ...
          <el-col :span="4">
            <el-form-item label="审核状态" prop="state">
              <el-select v-model="yishenFind.state" placeholder="请选择审核状态" clearable :style="{width: '100%'}">
...
<script>
  ...
  export default {
    ...
    computed: {},
    watch: {},
    created() {this.TeagetyishenheList(this.yishenFind)},
    mounted() {},
    methods: {
...
<style>
  .yishen{
    height: 100%;
    background: #fcfcfc url('../../../assets/bac/yishen.png') no-repeat top  right/ 10% auto;
  }
</style>
