        ...
        <el-card class="Forma">
          <el-row :gutter="0">
            ...
            >
              ...
              <el-col :span="12">
                <el-form-item
                  v-if="behavior.type != '荣誉奖项'"
                  label-width="110px"
                  label="级别"
                  prop="level"
                >
                  <el-select
                    v-model="behavior.level2"
                    placeholder="请选择奖项荣誉级别"
                    clearable
                    :style="{ width: '100%' }"
                    :disabled="true"
                  >
              ...
              <el-col :span="12">
                ...
                >
                  <el-select
                    v-model="behavior.order2"
                    placeholder="请选择奖项荣誉等次"
                    clearable
                    :style="{ width: '100%' }"
                    :disabled="true"
                  >
              ...
              <el-col :span="12">
                <el-form-item label="具体描述" prop="describe">
                  <el-input
                    v-model="behavior.describe"
                    type="textarea"
                    placeholder="请输入加分具体描述"
