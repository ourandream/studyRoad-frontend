  ...
  <div>
      ...
      <el-container>
        <el-container style="width: 50%">
          <el-breadcrumb separator="》" style="padding-left:10px;font-size:15px;">
            ...
            <el-breadcrumb-item>论文专利加分上报</el-breadcrumb-item>
          </el-breadcrumb>
        </el-container>
        <el-container>
          <el-row>
    ...
    <el-container>
      <el-container>
        <el-card class="Forma">
          <el-row :gutter="0">
            <el-form ref="paper" :model="paper" :rules="rules" size="mini" label-width="100px">
              <el-col :span="8">
                <el-form-item label="学年" prop="scyear">
                  <el-select v-model="paper.scyear" placeholder="论文专利发表学年" clearable :style="{width: '100%'}">
              ...
              <el-col :span="8">
                <el-form-item label="学期" prop="semester">
                  <el-select v-model="paper.semester" placeholder="论文专利发表学期" clearable :style="{width: '100%'}">
              ...
              <el-col :span="8">
                <el-form-item label="级别" prop="level">
                  <el-select v-model="paper.level" placeholder="论文专利级别" clearable :style="{width: '100%'}">
              ...
              <el-col :span="8">
                <el-form-item label="作者次别" prop="order">
                  <el-select v-model="paper.order" placeholder="请选择作者次别" clearable :style="{width: '100%'}">
              ...
              <el-col :span="8">
                <el-form-item label="名称" prop="name">
                  <el-input v-model="paper.name" placeholder="论文专利名称" clearable prefix-icon='el-icon-tickets'
      ...
      <el-container>
        <el-card style="width: 500px;height: 590px;margin-top: 3%;margin-left: 6%">
          <h3>论文专利评分标准</h3>
          <img src="../../../assets/img/lubwenzhuanli.jpg" style="width: 400px;height: 500px">
        </el-card>
      </el-container>
    </el-container>
  </div>
