      ...
      <el-container>
        <el-container style="width: 50%">
          <el-breadcrumb separator="》" style="padding-left:10px;font-size:15px;">
            ...
            <el-breadcrumb-item>其他实践加分上报</el-breadcrumb-item>
          </el-breadcrumb>
        </el-container>
        <el-container>
          <el-row>
    ...
    <el-container>
      <el-container>
        <el-card class="practiceform">
          <el-row :gutter="0">
            <el-form ref="praother" :model="praother" :rules="rules" size="mini" label-width="100px">
              <el-col :span="8">
                <el-form-item label="加分学年" prop="scyear" style="padding-top: 5%">
                  <el-select v-model="praother.scyear" placeholder="加分学年" clearable :style="{width: '100%'}">
              ...
              <el-col :span="8">
                <el-form-item label="加分学期" prop="semester" style="padding-top: 5%">
                  <el-select v-model="praother.semester" placeholder="加分学期" clearable :style="{width: '100%'}">
              ...
              <el-col :span="8">
                <el-form-item label="加分日期" prop="time" style="padding-top: 5%">
                  <el-date-picker v-model="praother.time" format="yyyy-MM-dd" value-format="yyyy-MM-dd"
                                  :style="{width: '100%'}" placeholder="加分日期" clearable></el-date-picker>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="加分事项" prop="describe" style="padding-top: 5%">
                  <el-input v-model="praother.describe" type="textarea" placeholder="请输入具体加分事项"
                            :autosize="{minRows: 4, maxRows: 4}" :style="{width: '100%'}"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="备注" prop="remarks" style="padding-top: 5%">
                  <el-input v-model="praother.remarks" type="textarea" placeholder="请输入其他实践加分备注"
                            :autosize="{minRows: 4, maxRows: 4}" :style="{width: '100%'}"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="24">
                <el-form-item label="加分数" prop="mark" style="padding-top: 5%">
                  <el-rate v-model="praother.mark" :max='20' show-score></el-rate>
                </el-form-item>
              </el-col>
              <el-col :span="24">
                <el-form-item label-width="130px" label="证明材料上传" prop="prove" style="padding-top: 5%">
      ...
      <el-container>
        <el-card style="width: 500px;height: 590px;margin-top: 3%;margin-left: 6%">
          <h3>其他实践加分标准</h3>
          <img src="../../../assets/img/practiceother.jpg" style="width: 400px;height: 500px">
        </el-card>
      </el-container>
    </el-container>
  </div>
