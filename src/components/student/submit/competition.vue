  ...
  <div>
      ...
      <el-container>
        <el-container style="width: 50%">
          <el-breadcrumb separator="》" style="padding-left:10px;font-size:15px;">
            ...
            <el-breadcrumb-item>学术竞赛加分上报</el-breadcrumb-item>
          </el-breadcrumb>
        </el-container>
        <el-container>
          <el-row>
    ...
    <el-container>
      <el-container>
        <el-card class="Forma">
          <el-row :gutter="0">
            <el-form ref="competition" :model="competition" :rules="rules" size="mini" label-width="100px">
              <el-col :span="8">
                <el-form-item label="学年" prop="scyear">
                  <el-select v-model="competition.scyear" placeholder="请选获奖学年" clearable :style="{width: '100%'}">
              ...
              <el-col :span="8">
                <el-form-item label="获奖时间" prop="time">
                  <el-date-picker v-model="competition.time" format="yyyy-MM-dd" value-format="yyyy-MM-dd"
                                  :style="{width: '100%'}" placeholder="请选择获奖时间" clearable></el-date-picker>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="奖项级别" prop="level">
                  <el-select v-model="competition.level" placeholder="请选择奖项级别" clearable :style="{width: '100%'}">
              ...
              <el-col :span="8">
                <el-form-item label="获奖等次" prop="order">
                  <el-select v-model="competition.order" placeholder="请选择获奖等次" clearable :style="{width: '100%'}">
              ...
              <el-col :span="8">
                <el-form-item label="竞赛名称" prop="name">
                  <el-input v-model="competition.name" placeholder="请输入竞赛名称" clearable prefix-icon='el-icon-tickets'
              ...
              <el-col :span="24">
                <el-form-item label="加分数" prop="mark">
                  <el-rate v-model="competition.mark" :max='50' show-score></el-rate>
                </el-form-item>
              </el-col>
              <el-col :span="24">
      ...
      <el-container>
        <el-card style="width: 500px;height: 590px;margin-top: 3%;margin-left: 6%">
          <h3>学术竞赛评分标准</h3>
          <img src="../../../assets/img/kejijinsai.jpg" style="width: 400px;height: 500px">
        </el-card>
      </el-container>
    </el-container>
  </div>
