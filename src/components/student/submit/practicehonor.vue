      ...
      <el-container>
        <el-container style="width: 50%">
          <el-breadcrumb separator="》" style="padding-left:10px;font-size:15px;">
            ...
            <el-breadcrumb-item>赛事荣誉加分上报</el-breadcrumb-item>
          </el-breadcrumb>
        </el-container>
        <el-container>
          <el-row>
            <el-button round @click="honor">赛事荣誉加分</el-button>
            <el-button type="success" round @click="qitashijian">其他实践加分</el-button>
          </el-row>
        </el-container>
      </el-container>
    </div>
    <el-container>
      <el-container>
        <el-card class="practiceform">
          <el-row :gutter="0">
            <el-form ref="prahonor" :model="prahonor" :rules="rules" size="mini" label-width="100px">
              <el-col :span="8">
                <el-form-item label="获奖学年" prop="scyear">
                  <el-select v-model="prahonor.scyear" placeholder="获奖学年" clearable :style="{width: '100%'}">
              ...
              <el-col :span="8">
                <el-form-item label="获奖学期" prop="semester">
                  <el-select v-model="prahonor.semester" placeholder="获奖学期" clearable :style="{width: '100%'}">
              ...
              <el-col :span="8">
                <el-form-item label="获奖时间" prop="time">
                  <el-date-picker v-model="prahonor.time" format="yyyy-MM-dd" value-format="yyyy-MM-dd"
                                  :style="{width: '100%'}" placeholder="获奖时间" clearable></el-date-picker>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="奖项级别" prop="level" style="padding-top: 2%">
                  <el-select v-model="prahonor.level" placeholder="请选择奖项级别" clearable :style="{width: '100%'}">
              ...
              <el-col :span="8">
                <el-form-item label="等次" prop="order" style="padding-top: 2%">
                  <el-select v-model="prahonor.order" placeholder="请选择等次" clearable :style="{width: '100%'}">
              ...
              <el-col :span="8">
                <el-form-item label="名称" prop="name" style="padding-top: 2%">
                  <el-input v-model="prahonor.name" placeholder="赛事荣誉名称" clearable :style="{width: '100%'}">
                  </el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="获奖描述" prop="describe" style="padding-top: 2%">
                  <el-input v-model="prahonor.describe" type="textarea" placeholder="请输入赛事荣誉获奖描述"
                            :autosize="{minRows: 4, maxRows: 4}" :style="{width: '100%'}"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="备注" prop="remarks" style="padding-top: 2%">
                  <el-input v-model="prahonor.remarks" type="textarea" placeholder="请输入赛事荣誉其他另加分事项"
                            :autosize="{minRows: 4, maxRows: 4}" :style="{width: '100%'}"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="24">
                <el-form-item label="加分数" prop="mark" style="padding-top: 2%">
                  <el-rate v-model="prahonor.mark" :max='51' show-score></el-rate>
                </el-form-item>
              </el-col>
              <el-col :span="24">
      ...
      <el-container>
        <el-card style="width: 500px;height: 590px;margin-top: 3%;margin-left: 6%">
          <h3>赛事荣誉加分标准</h3>
          <img src="../../../assets/img/practicehonor.jpg" style="width: 400px;height: 500px">
        </el-card>
      </el-container>
    </el-container>
  </div>
  ...
  export default {
    ...
    methods: {
      ...
      removeimage(fileList){
        this.hideUpload = fileList.length >= 1;
        var oldprove=this.prahonor.prove
        this.prahonor.prove=null
        this.proveDelete(oldprove)

      },
      submitsuccess(data){
        console.log(data)
        this.prahonor.prove=data.data.url
        console.log( "证明材料链接："+this.prahonor.prove+"牛逼")
      },
      honor () {
      ...
      submitForm() {
        this.$refs['prahonor'].validate(valid => {
          if (!valid) return
          // TODO 提交表单
          var stunum=this.$session.get("user").stunum
          this.setextrapoint(stunum,this.prahonor)
          var that = this;
          setTimeout(function(){
            that.$router.go(0)
          },800)
      ...
      resetForm() {
        this.$refs['prahonor'].resetFields()
      },
