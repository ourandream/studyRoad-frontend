    ...
    <el-container>
          ...
          <el-row :gutter="0">
            ...
            >
              ...
              <el-col :span="12">
                ...
                >
                  <el-input
                    v-model="prahonor.describe"
                    type="textarea"
                    placeholder="请输入赛事荣誉获奖描述"
              ...
              <el-col :span="12">
                ...
                >
                  <el-input
                    v-model="prahonor.remarks"
                    type="textarea"
                    placeholder="请输入赛事荣誉其他另加分事项"
                    :autosize="{ minRows: 4, maxRows: 4 }"
                    :style="{ width: '100%' }"
                  ></el-input>
                </el-form-item>
      ...
      <el-container>
        ...
        >
          <h3>赛事荣誉加分标准</h3>
          <img
            src="../../../assets/img/practicehonor.jpg"
