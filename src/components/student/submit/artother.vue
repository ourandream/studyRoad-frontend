          ...
          <el-row :gutter="0">
            ...
            >
              ...
              <el-col :span="12">
                ...
                >
                  <el-input
                    v-model="artother.describe"
                    type="textarea"
                    placeholder="请输入加分具体事项"
              ...
              <el-col :span="12">
                ...
                >
                  <el-input
                    v-model="artother.remarks"
                    type="textarea"
                    placeholder="请输入其他艺体加分备注事项"
                    :autosize="{ minRows: 4, maxRows: 4 }"
                    :style="{ width: '100%' }"
                  ></el-input>
                </el-form-item>
