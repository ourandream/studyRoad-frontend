<template>
    <div>
        ...
        <el-container>
          <el-container style="width: 50%">
            <el-breadcrumb separator="》" style="padding-left:10px;font-size:15px;">
              ...
              <el-breadcrumb-item>艺体参与加分上报</el-breadcrumb-item>
            </el-breadcrumb>
          </el-container>
          <el-container>
            <el-row>
      ...
      <el-container>
        ...
        <el-row :gutter="0">
          <el-form ref="other" :model="join" :rules="rules" size="mini" label-width="100px">
            <el-col :span="8">
              <el-form-item label="学年" prop="scyear">
                <el-select v-model="join.scyear" placeholder="参与学年" clearable :style="{width: '100%'}">
            ...
            <el-col :span="8">
              <el-form-item label="学期" prop="semester">
                <el-select v-model="join.semester" placeholder="参与学期" clearable :style="{width: '100%'}">
            ...
            <el-col :span="8">
              <el-form-item label="时间" prop="time">
                <el-date-picker v-model="join.time" format="yyyy-MM-dd" value-format="yyyy-MM-dd"
                                :style="{width: '100%'}" placeholder="参与时间" clearable></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="参与级别" prop="level" style="padding-top: 2%">
                <el-select v-model="join.level" placeholder="请选择参与级别" clearable :style="{width: '100%'}">
            ...
            <el-col :span="8">
              <el-form-item label="项目类别" prop="category" style="padding-top: 2%">
                <el-select v-model="join.category" placeholder="请选择项目类别" clearable :style="{width: '100%'}">
            ...
            <el-col :span="8">
              <el-form-item label="活动名称" prop="name" style="padding-top: 2%">
                <el-input v-model="join.name" placeholder="请输入活动名称" clearable :style="{width: '100%'}">
                </el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="活动描述" prop="describe" style="padding-top: 2%">
                <el-input v-model="join.describe" type="textarea" placeholder="请输入活动描述"
                          :autosize="{minRows: 4, maxRows: 4}" :style="{width: '100%'}"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="备注" prop="remarks" style="padding-top: 2%">
                <el-input v-model="join.remarks" type="textarea" placeholder="请输入活动参与的其他加分备注"
                          :autosize="{minRows: 4, maxRows: 4}" :style="{width: '100%'}"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="24">
        ...
        <el-container>
          <el-card style="width: 500px;height: 590px;margin-top: 3%;margin-left: 6%">
            <h3>艺体参与加分标准</h3>
            <img src="../../../assets/img/artjoin.jpg" style="width: 400px;height: 500px">
          </el-card>
        </el-container>
      </el-container>
    </div>
