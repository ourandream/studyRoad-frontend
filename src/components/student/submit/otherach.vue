      ...
      <el-container>
        <el-container style="width: 50%">
          ...
          >
            ...
            <el-breadcrumb-item>其他成果成果上报</el-breadcrumb-item>
          </el-breadcrumb>
        </el-container>
        <el-container>
          <el-row>
          ...
          <el-row :gutter="0">
            ...
            >
              ...
              <el-col :span="12">
                ...
                >
                  <el-input
                    v-model="otherky.describe"
                    type="textarea"
                    placeholder="请输入成果获得相关加分事项"
              ...
              <el-col :span="12">
                ...
                >
                  <el-input
                    v-model="otherky.remarks"
                    type="textarea"
                    placeholder="请输入成果获得相关加分备注"
                    :autosize="{ minRows: 4, maxRows: 4 }"
                    :style="{ width: '100%' }"
                  ></el-input>
                </el-form-item>
