  ...
  <div>
    <div>
      ...
      <el-breadcrumb separator="》" style="padding-left:10px;font-size:15px;">
        ...
        <el-breadcrumb-item>科研立项加分上报</el-breadcrumb-item>
      </el-breadcrumb>
      </el-container>
        <el-container>
          <el-row>
    ...
    <el-container>
      <el-container>
        <el-card class="Forma">
          <el-row :gutter="0">
            <el-form ref="science" :model="science" :rules="rules" size="mini" label-width="100px">
              <el-col :span="8">
                <el-form-item  label="学年" prop="scyear">
                  <el-select v-model="science.scyear" placeholder="科研立项学年" clearable :style="{width: '100%'}">
              ...
              <el-col :span="8">
                <el-form-item  label="学期" prop="semester">
                  <el-select v-model="science.semester" placeholder="科研立项学期" clearable :style="{width: '100%'}">
              ...
              <el-col :span="8">
                <el-form-item label="级别" prop="level">
                  <el-select v-model="science.level" placeholder="请选择立项级别" clearable :style="{width: '100%'}">
              ...
              <el-col :span="8">
                <el-form-item label="立项情况" prop="situation">
                  <el-select v-model="science.situation" placeholder="请选择立项情况" clearable :style="{width: '100%'}">
                    <el-option v-for="(item, index) in situationOptions" :key="index" :label="item.label"
                               :value="item.value" :disabled="item.disabled"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="项目名称" prop="name">
                  <el-input v-model="science.name" placeholder="请输入项目名称" clearable prefix-icon='el-icon-tickets'
              ...
              <el-col :span="24">
                <el-form-item label="加分数" prop="mark">
                  <el-rate v-model="science.mark" :max='25' show-score></el-rate>
                </el-form-item>
              </el-col>
              <el-col :span="24">
      ...
      <el-container>
        <el-card style="width: 500px;height: 590px;margin-top: 3%;margin-left: 6%">
          <h3>科研立项评分标准</h3>
          <img src="../../../assets/img/keyanlixiang.jpg" style="width: 400px;height: 500px">
        </el-card>
      </el-container>
    </el-container>
  </div>
