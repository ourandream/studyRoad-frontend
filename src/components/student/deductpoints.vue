    ...
    <el-container>
      <el-card class="deduct">
        <el-table
          ...
          style="width: 100%"
        >
          <el-table-column prop="scyear" label="扣分学年" sortable width="150">
          </el-table-column>

          <el-table-column label="扣分学期" width="150">
          ...
          <el-table-column prop="time" sortable label="扣分时间" width="150">
          </el-table-column>

          <el-table-column sortable width="150" label="扣分模块">
            <template slot-scope="scope">
          ...
          <el-table-column prop="matter" width="150" label="扣分事项">
          </el-table-column>

          <el-table-column prop="describe" label="扣分描述"> </el-table-column>

          <el-table-column prop="remarks" label="备注" width="150">
          </el-table-column>

          <el-table-column prop="mark" width="70" label="扣分数">
            <template slot-scope="scope">
              <div>
...
.deduct {
  ...
  height: 600px;
  margin-top: 2%;
  background: #fcfcfc url("../../assets/bac/reduce.png") no-repeat bottom right/
    25% auto;
}
</style>
