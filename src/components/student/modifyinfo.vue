<template>
    <el-dialog title="基本信息修改" :visible.sync="dialogFormVisible" class="modifyinfo" center @close="Close" >
    <el-row :gutter="15">
      <el-form ref="Student" :model="stu"  size="small" label-width="80px">
        <el-col :span="12">
          <el-form-item label="学号" prop="number">
            <el-input v-model="stu.number" placeholder="请输入学号" readonly :disabled='true' clearable
                      prefix-icon='el-icon-s-help' :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="姓名" prop="name">
            <el-input v-model="stu.name" placeholder="请输入姓名" readonly :disabled='true' clearable
                      prefix-icon='el-icon-s-help' :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="年级" prop="grade">
            <el-input v-model="stu.grade" placeholder="请输入年级" readonly :disabled='true' clearable
                      prefix-icon='el-icon-s-help' :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="班级" prop="class">
            <el-input v-model="stu.class" placeholder="请输入班级" readonly :disabled='true' clearable
                      prefix-icon='el-icon-s-help' :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="专业" prop="major">
            <el-input v-model="stu.major" placeholder="请输入专业" readonly :disabled='true' clearable
                      prefix-icon='el-icon-s-help' :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="宿舍" prop="dorm">
            <el-input v-model="stu.dorm" placeholder="请输入宿舍" readonly :disabled='true' clearable
                      prefix-icon='el-icon-s-help' :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="身份证号" prop="idcard">
            <el-input v-model="stu.idcard" placeholder="请输入身份证号" clearable prefix-icon='el-icon-s-help'
                      :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="民族" prop="nation">
            <el-input v-model="stu.nation" placeholder="请输入民族" clearable prefix-icon='el-icon-s-help'
                      :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="出生日期" prop="birthDate">
            <el-date-picker v-model="stu.birthDate" format="yyyy-MM-dd" value-format="yyyy-MM-dd"
                            :style="{width: '100%'}" placeholder="请选择出生日期" clearable></el-date-picker>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="籍贯" prop="naPlace">
            <el-input v-model="stu.naPlace" placeholder="请输入籍贯" clearable prefix-icon='el-icon-s-help'
                      :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="政治面貌" prop="poLook">
            <el-input v-model="stu.poLook" placeholder="请输入政治面貌" clearable prefix-icon='el-icon-s-help'
                      :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="电话" prop="phone">
            <el-input v-model="stu.phone" placeholder="请输入电话" clearable prefix-icon='el-icon-s-help'
                      :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="邮箱" prop="email">
            <el-input v-model="stu.email" placeholder="请输入邮箱" clearable prefix-icon='el-icon-s-help'
                      :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="微信" prop="wechat">
            <el-input v-model="stu.wechat" placeholder="请输入微信" clearable prefix-icon='el-icon-s-help'
                      :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="辅导员" prop="teacher">
            <el-input v-model="stu.teacher" placeholder="请输入辅导员" readonly :disabled='true' clearable
                      prefix-icon='el-icon-s-help' :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="教师电话" prop="teaphone">
            <el-input v-model="stu.teaphone" placeholder="请输入辅导员电话" readonly :disabled='true' clearable
                      prefix-icon='el-icon-s-help' :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="学籍状态" prop="state">
            <el-input v-model="stu.state" placeholder="请输入学籍状态" readonly :disabled='true' clearable
                      prefix-icon='el-icon-s-help' :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item size="large">
            <span style="padding-left: 37%"><el-button type="primary" @click="submit">提交保存</el-button></span>
          </el-form-item>
        </el-col>
      </el-form>
    </el-row>
