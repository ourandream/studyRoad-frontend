          ...
          <span style="padding-left: 10px" >
              <el-tooltip  placement="top" effect="light">
                <div slot="content" >不通过</div>
                    <el-button circle @click="manfail(scope.row)"  size="small" style="background-color: rgba(241,141,141,0.71)" icon="el-icon-circle-close"></el-button>
              </el-tooltip>
            </span>
        </template>
      </el-table-column>
...
<script>
  import { stugetdaishenheList, stuTongguo, stuButongguo } from '../../../api/Users'
  export default {
    name: 'manunreviewed',
    data(){
      return{
