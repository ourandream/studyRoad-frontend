<template>
  <div>
      ...
      <el-container>
        <el-card class="artlist">
          ...
          >
            ...
            <el-table-column prop="describe" label="艺体加分简介">
            </el-table-column>
      ...
      <el-container>
        <el-card class="artlist">
          ...
          >
            ...
            <el-table-column prop="describe" label="艺体素养加分简介">
            </el-table-column>
            <el-table-column prop="mark" label="加分数" width="70">
            </el-table-column>
    ...
    <ArtDetail
      ...
      @artChangedialogFormVisible="this.artChangescdialogFormVisible"
    ></ArtDetail>
  </div>
</template>
