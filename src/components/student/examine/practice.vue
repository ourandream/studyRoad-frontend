<template>
  <div>
            ...
            >
              <template slot-scope="scope">
                <el-tooltip  placement="top" effect="light">
                  ...
                  <el-button circle size="small" style="background-color: #ffecec" icon="el-icon-document" @click="pradetail(scope.row)"></el-button>
                </el-tooltip>
    ...
    <PracticeDetail
      ...
      @praChangedialogFormVisible="this.praChangescdialogFormVisible"></PracticeDetail>
  </div>
</template>
