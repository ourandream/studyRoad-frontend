<template>
  <div>
            ...
            >
              <template slot-scope="scope">
                <el-tooltip  placement="top" effect="light">
                  ...
                  <el-button circle size="small" style="background-color: #ffecec" icon="el-icon-document" @click="scdetail(scope.row)"></el-button>
                </el-tooltip>
    ...
    <ScDetail
      ...
      @scChangedialogFormVisible="this.scChangescdialogFormVisible"></ScDetail>
  </div>
