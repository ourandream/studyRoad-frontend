  ...
  <div>
    ...
    <el-card style="height: 100%;">
      ...
      <el-container>
        <el-container >
          <el-row :gutter="0">
            <el-form ref="gradeFind" :model="gradeFind" :rules="rules" size="mini" label-width="100px">
              <el-row>
              <el-col :span="7">
                <el-form-item label-width="110px" label="学年" prop="scyear">
                  <el-select v-model="gradeFind.scyear" placeholder="请选择成绩查询学年" clearable :style="{width: '100%'}">
              ...
              <el-col :span="7">
                <el-form-item label="课程性质" prop="courna">
                  <el-select v-model="gradeFind.courna" placeholder="请选择课程性质" clearable :style="{width: '100%'}">
                    <el-option v-for="(item, index) in cournaOptions" :key="index" :label="item.label"
                               :value="item.value" :disabled="item.disabled"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
        ...
        <el-container>
          <img src="../../assets/bac/achievement.png" style="height: 120px;width: 120px;">
        </el-container>
        <el-container>
          <el-descriptions size="medium" border direction="vertical" style="margin-left: 10%" >
            <el-descriptions-item label="综合绩点" label-class-name="my-label" content-class-name="my-content">{{Point}}</el-descriptions-item>
          </el-descriptions>
        </el-container>
      </el-container>
      <!--表格-->
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-tag  v-if="scope.row.courna==='选修'"type="warning" size="mini">选修</el-tag>
          </template>
        </el-table-column>
        <el-table-column
          prop="courid"
...
<script>
  ...
  export default {
    ...
    methods: {
      async getscorelist()
      {
        const { data }=await stugetscorelist(this.$session.get("user").stunum,this.gradeFind)
        console.log(data)
