    ...
    <el-container>
      <el-card class="postde">
        <el-table
          ...
          style="width: 100%"
        >
          <el-table-column prop="scyear" label="任职学年" sortable width="130">
          </el-table-column>
          <el-table-column label="任职学期" width="110">
          ...
          <el-table-column prop="time" sortable label="履职时间" width="105">
          </el-table-column>
          <el-table-column sortable width="105" label="岗位级别">
            <template slot-scope="scope">
          ...
          <el-table-column prop="organization" width="100" label="任职组织">
          </el-table-column>

          <el-table-column prop="age" label="任职情况" width="140">
          </el-table-column>

          <el-table-column prop="poname" label="职务" width="100">
          </el-table-column>

          <el-table-column prop="mark" width="70" label="加分数">
          </el-table-column>
          ...
          <el-table-column label="审核状态" width="80">
            <template slot-scope="scope">
              ...
              <div>
                <el-tag v-if="scope.row.sign === 0" type="warning" size="mini"
                  >待审核</el-tag
                >
              </div>
            </template>
...
.postde {
  ...
  height: 590px;
  margin-top: 1%;
  background: #fcfcfc url("../../../assets/bac/postde.png") no-repeat bottom
    right/ 25% auto;
}
</style>
